...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Config files
        DeclareLaunchArgument('cfg', default_value='', description='Path to RTAB-Map configuration file'), #os.path.join(get_package_share_directory('rtabmap_launch'), 'config', 'rtabmap_params.ini')
        ...
        DeclareLaunchArgument('stereo_namespace',        default_value='/stereo_camera/front', description=''), #/stereo_camera/front  |  /stereo_camera/back
        DeclareLaunchArgument('left_image_topic',        default_value=[LaunchConfiguration('stereo_namespace'), '/left/image_rect_color'], description=''),  #This is actually Gray
        DeclareLaunchArgument('right_image_topic',       default_value=[LaunchConfiguration('stereo_namespace'), '/right/image_rect_color'], description=''), #This is actually Gray
        ...
        DeclareLaunchArgument('compressed',            default_value='true', description='If you want to subscribe to compressed image topics'), #false
        ...
        DeclareLaunchArgument('scan_topic',           default_value='/laser/front_laser',  description=''), #/laser/all_laser  |  /laser/front_laser  |  /laser/back_laser
